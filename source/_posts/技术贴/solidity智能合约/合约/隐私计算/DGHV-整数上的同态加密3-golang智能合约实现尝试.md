---
title: DGHV:整数上的同态加密(3)-golang、智能合约实现尝试
tags:
  - null
categories:
  - tech
...
<img src="http://xwjpics.gumptlu.work/qinniu_uPic/MwFMIc-20210825092012252.png" alt="MwFMIc" style="zoom:67%;" />

## step_3 测试

<img src="http://xwjpics.gumptlu.work/qinniu_uPic/image-20210812230115286-20210825092012918.png" alt="image-20210812230115286" style="zoom:67%;" />

1的密文为：1318594171818636545920576603798101818973

<img src="http://xwjpics.gumptlu.work/qinniu_uPic/KBUSK7-20210825092013458.png" alt="KBUSK7" style="zoom:67%;" />
...
<img src="http://xwjpics.gumptlu.work/qinniu_uPic/ns3yge-20210825092014152.png" alt="ns3yge" style="zoom:67%;" />

1+1 = 0

<img src="http://xwjpics.gumptlu.work/qinniu_uPic/Zf6t09-20210825092014583.png" alt="Zf6t09" style="zoom:67%;" />

0+0 = 0

<img src="http://xwjpics.gumptlu.work/qinniu_uPic/hJzStL-20210825092015019.png" alt="hJzStL" style="zoom:67%;" />
...
2. 虽然输入只支持1bit，但是可以通过组合电路实现高阶的计算：
   ...
   * 逻辑与与逻辑异或具有完备性，可以实现组合电路任意高阶计算
   ...
   <img src="http://xwjpics.gumptlu.work/qinniu_uPic/image-20210812230914554-20210825092015984.png" alt="image-20210812230914554" style="zoom: 50%;" />
